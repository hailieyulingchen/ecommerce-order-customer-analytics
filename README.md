...
This project analyzes over 100k e-commerce orders, payments, and product categories using SQL and Tableau. 
...
3. Which payment methods contributed most to business performance?
4. How do installments influence customer spending behavior?

## Key Insights
1. Credit cards contributed nearly 80% of total revenue, indicating that payment-related promotions and checkout optimization should prioritize credit card users.
2. Health & beauty generated the highest revenue among all categories, suggesting a key category for marketing investment and inventory planning.
...
- Integrated multiple relational tables (orders, payments, products, and customer information) using SQL join. 
- Created analytical views to support KPI calculation and dashboard reporting.
